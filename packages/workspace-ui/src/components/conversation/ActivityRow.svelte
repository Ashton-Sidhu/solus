...
<style>
  ...
  .activity-target {
    ...
    color: var(--muted-foreground);
    opacity: 0.7;
    /* The smaller mono face sits slightly high beside the sans label even when
       their line boxes are geometrically centred. Lower it onto the baseline. */
    translate: 0 0.0625rem;
  }

  /* A sentence set in the mono face reads as a command. The sans face keeps it a
