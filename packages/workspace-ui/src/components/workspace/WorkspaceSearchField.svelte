...
>
  ...
  {#each chips as chip (chip.key)}
    <button
      type="button"
      class="flex h-[19px] shrink-0 cursor-pointer items-center gap-1 rounded-md border-0 bg-[color-mix(in_oklch,var(--primary)_13%,transparent)] pr-[5px] pl-[7px] font-medium text-[color-mix(in_oklch,var(--primary)_82%,var(--foreground))] transition-colors duration-150 hover:bg-[color-mix(in_oklch,var(--primary)_20%,transparent)]"
  ...
  {:else}
    <span
      class="shrink-0 rounded-md bg-[var(--wash-2)] px-[7px] py-[3px] text-muted-foreground shadow-[0_0_0_.5px_color-mix(in_oklch,var(--foreground)_12%,transparent),inset_0_-1px_0_color-mix(in_oklch,var(--foreground)_9%,transparent)]"
