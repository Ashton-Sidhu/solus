...
<Button
  type="button"
  class="flex h-[30px] w-full cursor-pointer items-center justify-center gap-1.5 rounded-lg border border-border bg-transparent px-3.5 text-sm font-medium text-(--solus-art-negative) transition-colors hover:bg-muted"
  onclick={resolve}
