...
>
 ...
 : 'bg-muted text-muted-foreground'}"
      ...
      <div class="flex flex-col gap-2">
        ...
        <!-- Styled like the message composer: transparent field, accent focus
             ring, forced 400 weight so typed text never reads bold. The
             wrapper's px-2.5 plus the ProseMirror's own 0.25rem left padding
             put the placeholder at left:0.875rem, on the editor text. -->
        <CommentEditor
          ...
          class="rounded-lg border border-border bg-transparent px-2.5 transition-colors focus-within:border-ring [&_.cm-content]:![min-height:3rem] [&_.cm-content]:![padding:0.5rem_0] [&_.cm-content]:![font-weight:400]"
        />
      </div>
