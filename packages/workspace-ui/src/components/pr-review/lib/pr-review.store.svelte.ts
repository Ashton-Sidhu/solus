...
import type { DiffScope, IpcContext, PrCheckoutContext, PrInterdiffResult, PrRepoCheckoutFailureReason, PrRepoCheckoutResult, PrReviewContext } from '@solus/contracts/types'
...
export class PrReviewState {
  ...
  loadDiff(force = false): void {
    ...
    void (async () => {
      ...
      do {
        const request: import('@solus/contracts/providers').PrDiffRequest = {
