...
<div class="text-sm flex min-h-0 flex-1 flex-col overflow-hidden">
  <!-- Either kind of generation earns the progress screen: this loader's own
       call, or the durable background one the Generate button queues. Generation
       takes precedence over a cached guide because that guide is the content the
       user asked Solus to replace. -->
