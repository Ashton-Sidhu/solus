  ...
  {#if hasTimeOfDay}
    <div class={ROW}>
      ...
      <TimeField
        ...
        label="Time"
        class="-mr-1.5 h-7 rounded-md border-0 px-1.5 font-mono text-workspace-chrome transition-colors duration-120 hover:bg-muted focus-within:border-transparent focus-within:ring-0 pointer-coarse:h-10"
      />
    </div>
  {/if}
</div>
