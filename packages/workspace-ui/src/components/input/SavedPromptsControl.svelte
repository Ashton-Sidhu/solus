<script lang="ts">
  ...
  import MenuSearch from "@solus/workspace-ui/components/ui/menu/menu-search.svelte";
  import MenuFooter from "@solus/workspace-ui/components/ui/menu/menu-footer.svelte";
  ...
  import type { Prompt, SavedPrompt } from "@solus/contracts/types";
  import {
    SAVED_PROMPTS_EVENT,
