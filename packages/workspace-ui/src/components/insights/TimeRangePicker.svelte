  ...
  <Popover.Trigger>
    {#snippet child({ props })}
      <button
        {...props}
        type="button"
        class="flex h-7.5 shrink-0 cursor-pointer items-center gap-1.5 rounded-lg px-2.5 text-insights-chrome whitespace-nowrap transition-[background-color,color,scale] hover:bg-[var(--wash-1)] active:scale-[0.96]"
