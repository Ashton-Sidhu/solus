...
<!--
  ...
  Rendered twice, and both are the way through when the nav column is not there:
  on the phone, and in a pane too narrow to hold the column. The second is why
  this is a snippet — hiding navigation without providing its replacement is how
