 ...
 *
 * Keep the search focus ring as light as its resting border. Pierre defaults
 * the ring to 2px for search inputs even when the tree focus ring is 1px.
 *
 ...
 */
export const FILE_TREE_THEME_CSS = `
