...
import { OUTBOX_TABLES } from '../../outbox/schema'
...
import { VAULT_TABLES } from '../../vault/schema'
...
export const PORTED_TABLES: readonly TableDefinition[] = [
  ...TASK_TABLES, ...WORK_TABLES, ...PLAN_TABLES, ...SHARING_TABLES, ...SESSION_TABLES, ...OUTBOX_TABLES, ...MIRROR_TABLES, ...VAULT_TABLES,
]
