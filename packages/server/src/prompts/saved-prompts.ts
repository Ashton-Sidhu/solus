...
const browserMarkSchema = z.object({
  id: z.string(),
  tool: z.enum(['pick', 'region', 'draw']),
  pin: z.number(),
...
const designSelectionSchema = z.object({
  ...
  browserMarks: z.array(browserMarkSchema).optional(),
  browserAppearance: z.enum(['light', 'dark']).optional(),
