<script lang="ts">
  ...
  import { createTabScroll } from "@solus/workspace-ui/lib/tabScroll.svelte";
  import SessionProgressRing from "@solus/workspace-ui/components/layout/SessionProgressRing.svelte";
  import ContextMeter from "@solus/workspace-ui/components/ContextMeter.svelte";
  import SettingsPopover from "@solus/workspace-ui/components/SettingsPopover.svelte";
  import { shouldShowSessionProgressRing } from "@solus/workspace-ui/components/layout/lib/session-progress-ring";
  import SessionContextMenu from "@solus/workspace-ui/components/session/SessionContextMenu.svelte";
  import * as Tabs from "@solus/workspace-ui/components/ui/tabs";
  import {
    getAttentionState,
    attentionLabel,
    getStatusIcon,
