...
import type { IpcContext, WireNormalizedEvent } from '@solus/contracts/types'

/** What the demo answers when an agent asks to mutate the visitor's repository. */
interface GitMutationRefusal {
  success: false
  error: string
}
