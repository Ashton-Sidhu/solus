...
<button
  type="button"
  class="inline-flex h-7 shrink-0 cursor-pointer items-center gap-1.5 rounded-lg border-0 bg-[color:color-mix(in_srgb,var(--solus-art-negative)_12%,transparent)] px-3 text-[0.75rem] font-semibold text-(--solus-art-negative) transition-[background-color,scale] duration-100 hover:bg-[color:color-mix(in_srgb,var(--solus-art-negative)_18%,transparent)] active:scale-[0.96]"
  onclick={resolve}
  use:tooltip={"Open an agent session to resolve the merge conflicts"}
>
