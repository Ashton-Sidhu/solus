...
import { PROVIDER_LOGO_NAMES } from '../packages/workspace-ui/src/components/settings/lib/provider-logos'
...
function readCollection(prefix: string): IconifyJSON {
  ...
  // SAFETY: `@iconify-json/*` packages ship `icons.json` in the published IconifyJSON
  // shape; a malformed collection is a broken dependency, not a runtime input.
