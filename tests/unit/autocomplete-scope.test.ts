...
describe('autocomplete scope', () => {
  test("a tab-bound composer searches the agent's worktree checkout", () => {
        ...
        'remote-tab': {
          run: {
            ...
            gitContext: {
              ...
              branch: 'feature',
              targetBranch: 'main',
              worktreePath: '/projects/solus/.git/solus/worktrees/feature',
            },
          } as Session['run'],
        },
      }),
    ...
    expect(scope).toEqual({
      ...
      workingDirectory: '/projects/solus/.git/solus/worktrees/feature',
    })
  })
        ...
        'local-tab': {
          run: {
            ...
            gitContext: {
              ...
              branch: 'other',
              targetBranch: 'main',
              worktreePath: '/projects/other/.git/solus/worktrees/other',
            },
          } as Session['run'],
        },
      }),
  ...
  test('a remote draft routes file search to its selected host before it has a tab', () => {
    ...
    const scope = resolveAutocompleteScope(
      workspace({}),
      '/remote/solus/.git/solus/worktrees/feature',
      undefined,
      'remote-server',
    )
    ...
    expect(scope).toEqual({
      tabId: 'local-tab',
      serverId: 'remote-server',
      workingDirectory: '/remote/solus/.git/solus/worktrees/feature',
    })
  })
