...
| [004 Shared host collaboration](004-shared-host-collaboration.md) | PLAN — decisions D1–D11 recorded (one shared Sprite per organization; automations run as their creator); work not started | Queue, steer and stop behavior are left to 003 |
