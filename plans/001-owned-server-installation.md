...
4. Integrate provider ownership and truthful setup/status on shared surfaces. Exercise relevant desktop, web, and mobile states if UI changes. No need to change native window behavior.
