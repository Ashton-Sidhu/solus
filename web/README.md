...
- `src/routes/+layout.svelte` owns route-aware canonical, Open Graph URL, and Twitter URL metadata for indexed pages. `src/app.html` owns shared defaults and image URLs. Keep those URLs aligned with the production domain.
