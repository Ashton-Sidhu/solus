...
import type { ResolvedTerminal, TerminalAppId, TerminalLaunchRequest } from '../shared/types'
import { getCliEnv } from './cli-env'
import { TERMINAL_APPS, terminalApp, type TerminalApp } from './terminal-apps'
