...
import { parseDiagramEmbed } from '../../shared/diagram-embed'
import type { GoogleDiagramAsset } from '../../shared/types'
...
function diagramFigure(asset: GoogleDiagramAsset): string {
...
export async function buildGoogleDocHtml(markdown: string, assets: GoogleDiagramAsset[]): Promise<string> {
