  ...
  {#if instructions}
    ...
    <div class="shadow-[inset_0_0.5px_0_var(--hairline)]">
      <div class="flex h-9 items-center gap-2 pr-3 pl-2.5 text-xs">
        <button
          type="button"
          class="flex h-7 min-w-0 flex-1 cursor-pointer items-center gap-2 rounded px-2 text-left text-muted-foreground transition-colors select-none hover:bg-[var(--wash-1)] hover:text-foreground"
