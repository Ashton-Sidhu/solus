...
>
  <TooltipUI.Root>
    ...
    class="flex h-full min-w-[1.25rem] items-center justify-center rounded-lg text-sm transition-[color] duration-[var(--duration-quick)] hover:text-(--solus-text-primary) focus-visible:outline-none focus-visible:bg-(--solus-accent-light) focus-visible:text-(--solus-text-primary) disabled:opacity-50"
