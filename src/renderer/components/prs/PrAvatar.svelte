<script lang="ts">
  import { initials } from "../pr-review/lib/activity-data";
...
{:else}
  <span
    class="grid shrink-0 place-items-center rounded-full bg-primary font-medium text-primary-foreground {size}"
  >
    {initials(name)}
  </span>
{/if}
