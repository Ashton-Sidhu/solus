...
export const ROW = 'flex h-7.5 items-center justify-between gap-3 text-[0.78125rem]'
...
export const MONO_VALUE = 'min-w-0 truncate font-mono text-[0.75rem] font-[430] tabular-nums text-foreground'
export const EYEBROW = 'text-[0.6875rem] font-semibold tracking-[0.1em] text-muted-foreground uppercase'
...
export const VALUE_TRIGGER =
  ...
  'text-[0.78125rem] font-[430] text-foreground transition-[background-color,color,scale] ' +
...
export const RAIL_FIELD =
  '-mr-1.5 h-7 rounded-md border-0 bg-transparent px-1.5 py-0 text-right font-mono text-[0.75rem] max-md:text-[0.75rem] font-[430] tabular-nums ' +
